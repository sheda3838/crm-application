...
const NoteCard = ({ note, onEdit, onDelete }) => {
  ...
  return (
    ...
    >
      {/* Timeline Node */}
      <div className="absolute left-0 top-6 w-3 h-3 bg-blue-500 rounded-full ring-4 ring-slate-50 dark:ring-slate-900 z-10" />
      
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow relative">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-slate-900 dark:text-white">
                ...
                {note.edited ? <span className="text-slate-400 text-xs ml-2 font-normal">(edited)</span> : ''}
              </p>
